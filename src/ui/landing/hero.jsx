...
const Hero = () => {
  ...
  return (
    <section className="px-4 xs:px-6 sm:px-8 md:px-12 lg:px-20 xl:px-36 mt-8 relative w-full overflow-x-hidden box-border">
      <div
        className="
      ...
      items-center w-full box-border overflow-x-hidden
    "
      >
        {/* Left Side */}
        <div
          className="flex-1 w-full lg:w-1/2 min-w-0 box-border"
          data-aos="fade-right"
        >
          <h1
            className="
        ...
        "
          ...
          flex items-center gap-3 box-border
        "
            data-aos="fade-up"
            data-aos-delay="200"
          >
        ...
        mb-5 lg:mb-0 md:max-w-[303px] w-full max-w-full min-w-0 box-border
      "
          data-aos="fade-left"
        >
